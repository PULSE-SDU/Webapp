...
export class DashboardComponent {
  equipmentData: Tag[] = [
    {
      nodeAddress: 'patient-monitor-c3',
      status: BatteryStatus.OFFLINE,
      batteryLevel: 15,
      prediction: '1 days left',
    },
    {
      nodeAddress: 'pulse-oximeter-h1',
      status: BatteryStatus.OFFLINE,
      batteryLevel: 18,
      prediction: '1 days left',
    },
    {
      nodeAddress: 'ventilator-b3',
      status: BatteryStatus.OFFLINE,
      batteryLevel: 22,
      prediction: '2 days left',
    },
    {
      nodeAddress: 'ecg-machine-g1',
      status: BatteryStatus.OFFLINE,
      batteryLevel: 38,
      prediction: '4 days left',
    },
    {
      nodeAddress: 'ventilator-b2',
      status: BatteryStatus.LOW,
      batteryLevel: 45,
      prediction: '5 days left',
    },
    {
      nodeAddress: 'defibrillator-a1',
      status: BatteryStatus.LOW,
      batteryLevel: 75,
      prediction: '10 days left',
    },
    {
      nodeAddress: 'infusion-pump-d2',
      status: BatteryStatus.LOW,
      batteryLevel: 82,
      prediction: '12 days left',
    },
    {
      nodeAddress: 'patient-monitor-c1',
      status: BatteryStatus.LOW,
      batteryLevel: 68,
      prediction: '8 days left',
    },
    {
      nodeAddress: 'ventilator-b1',
      status: BatteryStatus.GOOD,
      batteryLevel: 71,
      prediction: '9 days left',
    },
    {
      nodeAddress: 'ecg-machine-g2',
      status: BatteryStatus.GOOD,
      batteryLevel: 65,
      prediction: '7 days left',
    },
    {
      nodeAddress: 'pulse-oximeter-h2',
      status: BatteryStatus.GOOD,
      batteryLevel: 58,
      prediction: '6 days left',
    },
    {
      nodeAddress: 'defibrillator-a2',
      status: BatteryStatus.GOOD,
      batteryLevel: 85,
